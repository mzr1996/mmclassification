...
@VISUALIZERS.register_module()
class WandbClsVisualizer(Visualizer):
    """Universal Visualizer for classification task.
    ...
    def __init__(self,
        ...
        self.wandb = self._vis_backends[0].experiment

        self.resource_table = self.wandb.Table(columns=['name', 'iamge'])
    ...
    def add_datasample(self,
        ...
        columns = [
            'step', 'image_name', 'image', 'gt label', 'pred label',
            'pred score'
        ]
